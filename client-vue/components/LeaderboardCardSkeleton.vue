  ...
  >
    <div class="leaderboard-skeleton__top">
      <div class="leaderboard-skeleton__main">
        ...
        <div class="leaderboard-skeleton__identity">
          <div class="leaderboard-skeleton__title" />
...
.leaderboard-skeleton__identity {
  min-width: 0;
  flex: 1;
}
